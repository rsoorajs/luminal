...
pub struct BaseSorts {
    ...
    pub f8e4m3fn_dt: SortDef,
    pub f8e4m3fnuz_dt: SortDef,
    pub f8e5m2_dt: SortDef,
    pub f8e5m2fnuz_dt: SortDef,
...
impl BaseSorts {
    pub fn new() -> Self {
        Self {
            ...
            f8e4m3fn_dt: sort(DTYPE, "F8E4M3FN", &[]),
            f8e4m3fnuz_dt: sort(DTYPE, "F8E4M3FNUZ", &[]),
            f8e5m2_dt: sort(DTYPE, "F8E5M2", &[]),
            f8e5m2fnuz_dt: sort(DTYPE, "F8E5M2FNUZ", &[]),

...
// This example compiles and runs Gemma 3 4B on CUDA.
...
fn main() {
    ...
    // Download model if needed and prepare weights (converts to FP32 with Gemma transformations)
    ...
    for _ in 0..gen_tokens {
        ...
        // Stop on EOS tokens
        if sentence[0] == 1 || sentence[0] == 107 {

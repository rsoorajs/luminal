//! Elementwise modulo (remainder — luminal's Mod) — CUDA-lite's OWN op (ruling 2026-08-17:
...
//! reference runtime's modulo — assemblies are per-runtime, labels are
...
/// Destination-passing form: `Mod(lhs: read, rhs: read, dest0: write ↔ out0)`.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]

//! Truncated integer division (toward zero) — CUDA-lite's OWN op (ruling 2026-08-17:
...
//! reference runtime's trunc_div — assemblies are per-runtime, labels are
...
/// Destination-passing form: `TruncDiv(numerator: read, denominator: read, dest0: write ↔ out0)`.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Matches `LayoutTensorOpTruncDivFunctionalGeneric` and produces this
/// runtime's [`TruncDivFunctional`].

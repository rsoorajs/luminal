...
impl EgglogOp for KernelRoPE {
    ...
    fn rewrites(&self) -> Vec<Rule> {
        ...
        let angle_stage: &str = "
            ...
            (relation rope_safe_pad_left (IR IR EList IntExpr IntExpr IntExpr))
            (relation rope_safe_pad_right (IR IR EList IntExpr IntExpr IntExpr))
            (relation rope_row_dims_candidate (IntExpr IntExpr IntExpr IntExpr IntExpr))
            (relation rope_row_dims (IntExpr IntExpr IntExpr IntExpr IntExpr))
            (relation rope_tensor_range_candidate (IntExpr IntExpr IntExpr))
            (relation rope_tensor_range (IntExpr IntExpr IntExpr))

...
#
# Adapted for testing: fairscale replaced with standard PyTorch, KV cache removed,
...
class Llama3Model(nn.Module):
    """LLaMA3 transformer model adapted for testing (no fairscale, no KV cache)."""

    def __init__(self, params: Optional[ModelArgs] = None):
        super().__init__()
        if params is None:
            params = ModelArgs()
        self.params = params
